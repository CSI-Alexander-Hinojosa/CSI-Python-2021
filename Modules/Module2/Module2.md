...
https://www.markdownguide.org/getting-started/
 ...
 - Answer: The benefit of using Markdown is because it is a lightweight market language that you can use to add formatting elements to plaintext text documents.    

What does "cd" stand for?

 - Answer: cd stands for taking you back to one directory.

Did you get stuck at any point or become confused with your console? (yes/no) If so, what happened? How did you solve it?

 - Answer: I was not stuck in any point with my console. 

Did you consider searching google for other commands to run? What did you try? 

 - Answer: For now, i did not concider to serch google for other commands to run. 

What would you like to program? 

 - Answer: I would like to porgram web pages for companies and program softwares for machines.  
